...
<body>
    ...
    <section class="home">
        ...
        <div class="details">
            <p><strong>Nom:</strong> <span class="info">{{ $etudiantName }}</span></p>
            <p><strong>filiere:</strong> <span class="info">{{ $etudiantFiliere }}</span></p>
            <p><strong>Email:</strong> <span class="info">{{ $etudiantEmail }}</span></p>
            <!-- Assuming you're displaying the password for some specific reason -->
            <p><strong>Mot de passe:</strong> <span class="info">{{ $etudiantPassword }}</span></p>
        </div>
    ...
    <!--             <label for="filiere">filiere:</label>
                ...
                <input type="hidden" id="studentId" value="{{ $etudiantId }}"
    ...
    <script>
        $(document).ready(function() {
                ...
                $.ajax({
                    url: "{{ route('etudiant.mdp') }}", // Update with your route
                    type: 'PATCH',
                    dataType: 'json',
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                    },
                    data: { password: mdp, id: studentId },
